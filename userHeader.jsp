...
ResultSet rs=dbConnection.selectOperation("SELECT * FROM user_details where id='"+id+"'");
String name="";
if(rs.next())
{
		...
		<div class="center">
			<div class="header_area">
				<div class="logo floatleft">
					<a href="StudentHome.jsp?Result="><img src="imgs/logo.png" alt="" /></a>
				</div>
			...
			<div class="main_menu_area" style="margin-top: 10px">
				<ul id="nav">
					<li><a href="StudentHome.jsp?Result=">Home</a></li>
