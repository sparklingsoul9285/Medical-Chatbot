		...
		<div class="center">
			...
			<div class="main_menu_area" style="margin-top: 10px">
				<ul id="nav">
					...
					<li><a href="UserSignIn.jsp?Result=">Student</a>
						<ul>
					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						<div
							...
							<form action="AddNewRecord" method="post">
								<div class="pageform">
									<label
										style="color: #0084b4; text-align: center; margin-bottom: 7%">Admin
										Login</label><br> <label>Symtons</label><br> <input
										type="text" name="a" required="required"><br>
									<label>Password</label><br> 
									<textarea rows="5" cols="25" name="b"></textarea>
									<br>
